 ...
 * GOAT Bot 2.0
 * Updated: 2025-08-29 12:50:00 UTC
 * Developer: DithetoMokgabudi
 *
 * Changes:
 * - Add MANYCHAT_PATH_HINT to pick correct API prefix for your workspace ("whatsapp" or "wa").
 * - Prefer /whatsapp/sending/sendImage when MANYCHAT_PATH_HINT=whatsapp (avoids 404 on /wa).
 * - Lower default per-attempt timeout to 5000ms so we can try more endpoints within the budget.
 * - Keep circuit breaker and SVG→PNG logic intact.
 */
...
async function postToManyChatEndpoints(
  ...
  // Lower default attempt to 5s so we can try multiple endpoints in the 10–12s total budget
